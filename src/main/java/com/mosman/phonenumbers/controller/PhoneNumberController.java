...
public class PhoneNumberController {
    ...
    /// @return [PhoneNumbersPageResponseDTO] representing the search response
    @GetMapping
    ...
    /// @param requestBody      [PhoneNumberPatchDTO] representing the fields to patch in the phonenumber resource. Only status is supported.
    /// @return [PhoneNumberDTO] representing the updated phonenumber resource
